...
usbBackupPath=/usr/local/etc/usbbackup
usbBackupConfigPath=$usbBackupPath/config
usbBackupFile=$usbBackupConfigPath/usbbackup.json
count=1

mkdir -p $usbBackupPath
mkdir -p $usbBackupConfigPath

#update from 1.2.3 -> 1.3.3
