...
while : ; do
  ...
  case $1 in
    ...
    rm)     if [[ "$3" != "" ]] ; then
            ...
            if [[ "$2" = "trash" ]] ; then
              echo -e -n "\033[35mQ & A?: \033[33mDo you really want to \033[31mdelete \033[33mthe trashbin? \033[0m[\033[32my\033[0m/\033[31mN\033[0m] : " ;
              read option
              case $option in
              ...
              echo -e -n "\033[35mQ & A?: \033[33mDo you really want to \033[31mdelete \033[33mthe deactivation list? \033[0m[\033[32my\033[0m/\033[31mN\033[0m] : " ;
              read option
              case $option in
